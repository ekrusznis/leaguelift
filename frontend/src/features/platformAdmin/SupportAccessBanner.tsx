...
export function SupportAccessBanner({ access }: { access: PlatformSupportAccess }) {
	...
	return (
		<section aria-label="Active platform support access" className="flex flex-wrap items-center justify-between gap-3 rounded-xl border border-amber-300 bg-amber-50 dark:bg-amber-950 px-4 py-3 text-sm text-amber-950">
			<div>
			...
			<div className="flex flex-wrap gap-2">
				<Link to={`/app/platform/organizations/${access.organizationId}`} className="rounded-md border border-amber-400 bg-white dark:bg-[#111827] px-3 py-2 font-medium hover:bg-amber-100">
