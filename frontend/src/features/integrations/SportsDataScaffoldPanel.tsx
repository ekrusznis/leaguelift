...
export function SportsDataScaffoldPanel({ organizationId }: { organizationId: string }) {
	...
	return (
		<section className="rounded-xl border border-slate-200 bg-white p-5" aria-labelledby="sports-data-heading">
			...
			<p className="mt-4 text-xs text-slate-500">GameChanger and MaxPreps remain partner-pending. Existing CSV and ICS workflows below are the supported paths today; LeagueLift does not scrape either consumer site or invent an unsupported direct client.</p>
		</section>
	);
}
