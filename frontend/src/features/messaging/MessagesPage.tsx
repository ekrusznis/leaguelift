	...
	return (
		<div className="flex flex-col gap-8">
			<header>
				...
				<p className="mt-2 max-w-3xl text-slate-gray">Phase 25 messaging includes one-way broadcasts, coach/family conversations, gated athlete peer messaging, mandatory guardian visibility, message-level reporting, retained moderation history, safety locks, and guardian communication controls.</p>
			</header>
