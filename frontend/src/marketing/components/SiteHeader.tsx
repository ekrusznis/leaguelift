					...
					<nav aria-label="Primary" className="hidden items-center gap-1 lg:flex">
						...
						{SIMPLE_NAV_LINKS.map((link) => (
							<Link
								...
								className="rounded-md px-3 py-2 text-sm font-medium text-white/90 hover:text-white focus-visible:outline focus-visible:outline-2 focus-visible:outline-green-400"
							>
								{link.label}
							</Link>
						))}
