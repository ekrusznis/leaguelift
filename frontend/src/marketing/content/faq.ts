export const HOMEPAGE_FAQ: { question: string; answer: string }[] = [
	...
	},
	{
		...
		answer: "Yes. Each team can have its own branded public page with a draft, preview, and publish workflow.",
	},
	{
	...
	},
	{
		...
		answer: "No. Family credits are organization-approved fee credits only — they are not cash accounts and are not withdrawable or transferable.",
	},
	{
