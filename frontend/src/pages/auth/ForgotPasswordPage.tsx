...
/**
 * There is no password-reset-by-email endpoint yet — this codebase has no outbound
 * email sending infrastructure at all (see docs/launch-checklist.md). This validates
 * client-side and shows the section 27.2-style "check your email" state, but does
 * not send anything. Wire this once an email provider is chosen and a real
 * `POST /api/v1/auth/forgot-password`-style endpoint exists (docs/openapi.yaml).
 */
