...
/** Family Calendar (Calendar tab) — real combined schedule across every linked athlete's teams (ADR-103). */
    ...
    <ThemedView style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.agenda}>
        {eventsQuery.data && datesWithEvents.length === 0 && (
          <EmptyState title="No events scheduled" description="Nothing on your family's schedule yet." />
        )}
