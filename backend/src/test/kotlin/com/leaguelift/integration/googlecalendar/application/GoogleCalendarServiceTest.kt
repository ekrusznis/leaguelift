...
import com.leaguelift.integration.core.application.IntegrationAccessToken
...
import com.leaguelift.integration.googlecalendar.persistence.GoogleCalendarRepository
...
class GoogleCalendarServiceTest {
    ...
    fun `calendar selection accepts only a writable calendar returned by the provider`() {
        ...
        val setting = GoogleCalendarConnectionSetting(
            ...
            syncDirection = GoogleCalendarSyncDirection.LEAGUELIFT_TO_GOOGLE,
