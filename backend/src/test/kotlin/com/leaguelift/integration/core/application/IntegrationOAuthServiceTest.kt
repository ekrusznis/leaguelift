...
import com.leaguelift.integration.core.domain.IntegrationOAuthState
...
class IntegrationOAuthServiceTest {
    ...
    private val properties = IntegrationProperties(
        ...
        providers = mapOf(
            "quickbooks-online" to IntegrationProviderRuntimeProperties(
                enabled = true,
                clientId = "client-id",
    ...
    private val service = IntegrationOAuthService(
        catalogService,
    ...
    fun `successful callback encrypts tokens before marking the connection connected`() {
        ...
        val state = IntegrationOAuthState(
            id = UUID.randomUUID(),
        ...
        val stored = IntegrationCredentialSecret(
            id = UUID.randomUUID(),
    ...
    private fun connection(organizationId: UUID, actorId: UUID) = IntegrationConnection(
        id = UUID.randomUUID(),
        provider = IntegrationProvider.QUICKBOOKS_ONLINE,
        category = IntegrationCategory.ACCOUNTING,
        ownerType = IntegrationOwnerType.ORGANIZATION,
