...
class PlatformAdminConsoleServiceTest {
	...
	private val admin = CurrentUser(UUID.randomUUID(), "employee@leaguelift.com", "Support Employee", platformAdministrator = true)
	...
	private fun access(id: UUID, orgId: UUID, expiresAt: Instant) = PlatformSupportAccess(
		id = id,
	...
	private fun organization(id: UUID) = PlatformOrganizationDetail(
		organizationId = id,
