...
class ActivityFeedServiceTest {
    ...
    private fun membership(organizationId: UUID) =
    ...
    private fun event(organizationId: UUID?) =
        AuditEvent(UUID.randomUUID(), UUID.randomUUID(), organizationId, "team.created", "team", UUID.randomUUID(), "{}", Instant.now())
