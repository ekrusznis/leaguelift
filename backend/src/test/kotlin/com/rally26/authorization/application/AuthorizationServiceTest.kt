...
class AuthorizationServiceTest {
    ...
    private fun team(organizationId: UUID) =
        Team(
            id = UUID.randomUUID(),
    ...
    fun `listTeamStaffUserIds combines explicit team grants with inherited org owner-admin, deduplicated`() {
        ...
        every { membershipRepository.listActiveManagers(organizationId) } returns
            listOf(membership(organizationId, ownerUserId, MembershipRole.OWNER))
