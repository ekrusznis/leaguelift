    ...
    fun `confirm, transfer, refund produces a negative balance that nets against the next transfer`() {
        ...
        val organization =
            organizationService.create(
                "Riverside Soccer",
                "riverside-soccer-transfer-${System.nanoTime()}",
        ...
        every { stripeConnectClient.retrieveAccountStatus(any()) } returns
            StripeAccountStatus(detailsSubmitted = true, chargesEnabled = true, payoutsEnabled = true)
        ...
        val campaign =
            campaignService.create(
                ...
                null,
                "Spring Trip Fund",
                "spring-trip-fund-${System.nanoTime()}",
                null,
                CampaignType.TRAVEL,
                100_000L,
                "USD",
