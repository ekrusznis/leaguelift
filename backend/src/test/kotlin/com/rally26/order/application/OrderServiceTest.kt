...
class OrderServiceTest {
	...
	fun `confirmFromWebhook confirms a paid Printify order and records fulfillment history`() {
		...
		every { mediaAssignmentService.getActiveAssignment(com.rally26.media.domain.MediaEntityType.PRODUCT, product.id, com.rally26.media.domain.MediaUsageSlot.PRODUCT_DESIGN) } returns designAssignment
