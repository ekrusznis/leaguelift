...
class MediaAssignmentServiceTest {
    ...
    fun `assign requires manager role`() {
        ...
        every { mediaAssignmentRepository.insert(any(), any(), any(), any(), any(), any(), any(), any()) } returns
            sampleAssignment(asset.id)
