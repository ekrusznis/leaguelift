...
class IcsCalendarProviderTest {
	...
	private fun event(
		...
		id = UUID.randomUUID(), organizationId = UUID.randomUUID(), teamId = UUID.randomUUID(), tournamentId = null,
		opponentTeamId = null, opponentName = null, eventType = EventType.COMPETITION, title = null, description = description,
		status = status, startAt = startAt, endAt = endAt, arrivalAt = null, meetingAt = null, timezone = "America/New_York",
		venueName = "Riverside Park", address = "123 Main St", latitude = null, longitude = null, area = "Field 3",
		meetingPoint = meetingPoint, directionsNotes = directionsNotes, visibility = EventVisibility.TEAM,
	...
	fun `never includes private meeting point or directions notes`() {
		val ics = provider.buildIcs(event(meetingPoint = "Meet by the flagpole", directionsNotes = "Use the north gate, code 1234"), "Practice")
