...
import com.rally26.integration.printify.infra.PrintifyPrintProviderDetail
import com.rally26.integration.printify.infra.PrintifyPrintProviderSummary
...
class VendorSelectionServiceTest {
    ...
    fun `listUsPrintProviders keeps only providers located in the US`() {
        every { printifyCatalogClient.listPrintProviders(99L) } returns
            listOf(
