...
class SupportCaseStatusChangedEmailHandlerTest {
	...
	private fun handlerWith(resendTemplateProperties: ResendTemplateProperties) = SupportCaseStatusChangedEmailHandler(
		repository,
		emailProvider,
	...
	private fun supportCase(status: SupportCaseStatus, resolution: String?): SupportCase {
		val now = Instant.parse("2026-08-04T13:30:00Z")
		return SupportCase(
			id = UUID.randomUUID(),
