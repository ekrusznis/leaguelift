...
values
    ('10000000-0000-4000-8000-000000000001', 'getting-started-with-leaguelift',
     'Getting started with LeagueLift',
     'Understand the invitation-only account model and the first steps for an organization owner.',
     E'## Organization owners\n\nOnly an organization owner may create a new LeagueLift organization through public registration. After verifying the owner email, the owner can set up organization details, teams, tournaments, households, participants, fees, pages, events, and other enabled modules.\n\n## Everyone else\n\nAdministrators, coaches, guardians, and permitted athletes receive organization-issued invitations. They do not create independent public accounts.',
    ...
    ('10000000-0000-4000-8000-000000000003', 'fees-and-payments-overview',
     ...
     E'Households can view assigned fees, due dates, payment history, adjustments, and outstanding balances for their own household. Organization staff record or manage payment activity according to their permissions. LeagueLift fee credits are organization-approved fee reductions; they are not cash, transferable balances, or a bank account.',
    ...
    ('10000000-0000-4000-8000-000000000010', 'platform-support-access',
     ...
     'How LeagueLift employees enter a customer workspace for support.',
     E'Platform support access is reasoned, time-bounded, and scoped to one organization. The LeagueLift employee remains the authenticated actor; the system does not silently impersonate the customer. Start and end activity is audited.',
