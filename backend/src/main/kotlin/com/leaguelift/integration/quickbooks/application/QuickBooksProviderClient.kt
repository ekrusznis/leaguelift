...
import com.leaguelift.integration.quickbooks.domain.QuickBooksCompany
...
class ScaffoldQuickBooksProviderClient(
    ...
    override fun readCompany(accessToken: String, realmId: String): QuickBooksCompany {
        ...
        return QuickBooksCompany(realmId, "LeagueLift Sandbox Organization", "US", "USD")
    }
    ...
    override fun listAccounts(accessToken: String, realmId: String): List<QuickBooksAccount> {
        ...
        return listOf(
            ...
            QuickBooksAccount("qb-bank-clearing", "LeagueLift Clearing", "Bank", true),
