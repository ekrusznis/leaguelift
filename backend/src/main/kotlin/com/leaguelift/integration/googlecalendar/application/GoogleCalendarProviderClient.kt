package com.leaguelift.integration.googlecalendar.application

import com.leaguelift.common.error.ServiceUnavailableException
import com.leaguelift.config.IntegrationProperties
import com.leaguelift.integration.googlecalendar.domain.GoogleCalendarDescriptor
import com.leaguelift.integration.googlecalendar.domain.GoogleCalendarEventPayload
import com.leaguelift.integration.googlecalendar.domain.GoogleCalendarWriteResult
...
class ScaffoldGoogleCalendarProviderClient(
    ...
    override fun listCalendars(accessToken: String): List<GoogleCalendarDescriptor> {
        ...
        return listOf(
            ...
            GoogleCalendarDescriptor("league-lift-test", "LeagueLift test calendar", "America/New_York", primary = false, writable = true),
