package com.leaguelift.integration.sportsdata.web
...
import com.leaguelift.integration.sportsdata.application.SportsDataOverview
...
import com.leaguelift.integration.sportsdata.domain.SportsDataPreview
...
fun SportsDataExternalRecordRequest.toDomain() = SportsDataExternalRecord(
    runCatching { SportsDataEntityType.valueOf(entityType.uppercase()) }.getOrElse { throw com.leaguelift.common.error.ValidationException("Unknown sports-data entity type.") },
    externalId,
    externalParentId,
    name,
    payload,
