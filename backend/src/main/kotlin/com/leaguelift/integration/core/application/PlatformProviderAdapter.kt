...
/** Stripe-backed LeagueLift subscription billing seam. It is platform-operated;
...
class DisabledPlatformSubscriptionBillingProvider : PlatformSubscriptionBillingProvider {
    ...
    private fun unavailable(): Nothing = throw ServiceUnavailableException(
        ...
        "LeagueLift subscription billing is scaffolded but has not been activated against verified Stripe products and webhook contracts.",
    )
}
