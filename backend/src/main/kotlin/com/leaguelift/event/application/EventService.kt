...
class EventService(
	...
	/** Shared with [com.leaguelift.event.web.EventController]'s response mapping so calendar/directions and the JSON API compute the exact same title. */
	 ...
	 * [com.leaguelift.dashboard.application.ParentDashboardService]'s existing
