 ...
 * already established. Active whenever `leaguelift.sms.provider` is unset or anything
 ...
 */
@Component
@ConditionalOnProperty(prefix = "leaguelift.sms", name = ["provider"], havingValue = "logging", matchIfMissing = true)
