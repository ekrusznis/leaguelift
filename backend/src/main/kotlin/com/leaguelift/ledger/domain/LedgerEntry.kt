 ...
 */
enum class LedgerEntryType { CONTRIBUTION, GROSS_SALE, PRODUCTION_COST, LEAGUELIFT_PLATFORM_FEE, ORGANIZATION_EARNING, TRANSFER, REFUND, OFFLINE_SETTLEMENT, MANUAL_ADJUSTMENT }
