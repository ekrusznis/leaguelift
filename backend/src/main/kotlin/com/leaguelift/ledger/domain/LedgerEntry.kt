package com.leaguelift.ledger.domain
 ...
 */
enum class LedgerEntryType { CONTRIBUTION, GROSS_SALE, PRODUCTION_COST, LEAGUELIFT_PLATFORM_FEE, ORGANIZATION_EARNING, TRANSFER, REFUND, OFFLINE_SETTLEMENT }

enum class LedgerDirection { CREDIT, DEBIT }

enum class LedgerSourceType { CONTRIBUTION, ORDER, TRANSFER, REFUND, SPONSORSHIP }
