package com.leaguelift.onboarding.web

import com.leaguelift.membership.domain.MembershipRole
import com.leaguelift.onboarding.application.BulkInvitationCommand
...
fun OnboardingPreviewRow.toResponse() = OnboardingPreviewRowResponse(
	rowNumber,
	recordType?.name,
	externalId,
	label,
...
fun OnboardingImportPreview.toResponse() = OnboardingImportPreviewResponse(
	fileName,
	contentHash,
	totalRows,
	validRows,
...
fun ImportedOnboardingEntity.toResponse() = ImportedOnboardingEntityResponse(
	recordType.name,
	externalId,
	entityId,
	label,
...
fun OnboardingImportRowError.toResponse() = OnboardingImportRowErrorResponse(
	rowNumber,
	recordType?.name,
	externalId,
	message,
...
fun OnboardingImportResult.toResponse() = OnboardingImportResultResponse(
	fileName,
	contentHash,
	createdCount,
	updatedCount,
...
fun BulkActionResult.toResponse() = BulkActionResponse(
	requestedCount,
	succeededCount,
	skippedCount,
	failedCount,
