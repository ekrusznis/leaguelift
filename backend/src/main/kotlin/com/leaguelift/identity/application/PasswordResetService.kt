...
import com.leaguelift.identity.persistence.PasswordResetTokenRepository
...
class PasswordResetService(
	...
	fun complete(token: String, password: String) {
		val record = passwordResetTokenRepository.findByTokenHash(sha256Hex(token))
		...
		val user = appUserRepository.findById(record.userId)
