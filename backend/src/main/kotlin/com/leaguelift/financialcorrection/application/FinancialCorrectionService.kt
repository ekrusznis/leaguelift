...
import com.leaguelift.financialcorrection.domain.FinancialCorrectionPreview
...
class FinancialCorrectionService(
    ...
    private fun previewInternal(
        ...
        val warnings = buildList {
            if (resolved.correctionType == FinancialCorrectionType.REFUND) {
                ...
                add("The LeagueLift platform fee is not returned; the organization earning reversal follows the existing ledger policy.")
    ...
    private fun createProviderRefund(target: ResolvedCorrectionTarget, amountMinor: Long, idempotencyKey: String): String = try {
        ...
        throw ServiceUnavailableException("REFUND_PROVIDER_UNAVAILABLE", "The payment provider could not complete the refund. No LeagueLift correction was recorded.")
    }
