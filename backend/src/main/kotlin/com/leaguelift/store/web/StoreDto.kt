...
data class UpdateStoreStatusRequest(@field:NotNull val status: StoreStatus)
...
data class PublicProductVariantResponse(val id: UUID, val label: String, val priceMinor: Long, val currency: String)
...
data class PublicStoreResponse(val id: UUID, val name: String, val slug: String, val products: List<PublicProductResponse>)
