package com.rally26.seasonrollover.persistence
...
@Repository
class SeasonRolloverRepository(
    ...
    fun listBranding(
        organizationId: UUID,
        teamId: UUID,
    ): List<SeasonRolloverBrandingItem> =
        jdbcClient
            .sql(
                """
