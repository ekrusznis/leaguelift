...
fun SeasonRolloverPreview.toResponse() =
    SeasonRolloverPreviewResponse(
        confirmationHash = confirmationHash,
        sourceTeam =
            SeasonRolloverTeamResponse(
                sourceTeam.id,
                sourceTeam.name,
                sourceTeam.sport,
                sourceTeam.season,
                sourceTeam.contactEmail,
            ),
        destinationTeam =
            SeasonRolloverTeamResponse(
                null,
                ...
                destinationTeam.season,
                destinationTeam.contactEmail,
            ),
...
fun SeasonRolloverResult.toResponse() =
