...
class EventController(
    ...
    fun listForTournament(
        ...
        eventService
            .listForTournament(
                ...
                page * size,
                size,
            ).map { it.toResponseWithNames(organizationId) }
    ...
    fun listForParticipant(
        ...
        eventService.listForParticipant(organizationId, participantId, currentUser, page * size, size).map {
            it.toResponseWithNames(organizationId)
        }
    ...
    fun householdIcs(
        ...
        icsResponse(eventService.getIcsForHousehold(organizationId, householdId, currentUser), "household-$householdId.ics")

    private fun icsResponse(
        ics: String,
        filename: String,
    ): ResponseEntity<String> =
        ResponseEntity
