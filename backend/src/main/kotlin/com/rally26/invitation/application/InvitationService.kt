...
class InvitationService(
    ...
    fun invite(
            ...
            throw ValidationException(
                ...
                listOf(
                    com.rally26.common.error
                        .FieldError("role", "Not an invitable role."),
                ),
            )
        }
        ...
        outboxWriter.write(
            ...
            payloadJson =
                """{"invitationId":"${invitation.id}","email":"$normalizedEmail",""" +
                    """"role":"${role.name}","acceptToken":"$rawToken"}""",
        )
    ...
    fun accept(
        ...
        val invitation =
            invitationRepository.findByTokenHash(sha256Hex(token))
