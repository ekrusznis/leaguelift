package com.rally26.offlinefinance.persistence
...
@Repository
class OfflineFinancialRecordRepository(
    ...
    fun findById(
        ...
        jdbcClient
            .sql("select $COLUMNS from offline_financial_record where id = :id and organization_id = :organizationId")
            .param("id", id)
    ...
    fun findByIdForUpdate(
        ...
        jdbcClient
            .sql("select $COLUMNS from offline_financial_record where id = :id and organization_id = :organizationId for update")
            .param("id", id)
            .param("organizationId", organizationId)
            .query(::mapRow)
            .optional()
    ...
    fun findByIdempotencyKey(
        ...
        jdbcClient
            .sql(
                "select $COLUMNS from offline_financial_record where organization_id = :organizationId and idempotency_key = :idempotencyKey",
            ).param("organizationId", organizationId)
    ...
    fun findByFingerprint(
        ...
        jdbcClient
            .sql(
                "select $COLUMNS from offline_financial_record where organization_id = :organizationId and duplicate_fingerprint = :fingerprint",
            ).param("organizationId", organizationId)
    ...
    fun markReversed(
        ...
        jdbcClient
            ...
            .param("reversedAt", Timestamp.from(reversedAt))
            .param("reason", reason)
            .param("id", id)
            .param("organizationId", organizationId)
            .update()
