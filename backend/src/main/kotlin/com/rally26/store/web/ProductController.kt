...
class ProductController(
    ...
    fun listUsPrintProviders(
        ...
        productService.listUsPrintProviders(organizationId, blueprintId, currentUser).map {
            it.toResponse()
        }
    ...
    fun listCatalogVariants(
        ...
        productService.listCatalogVariants(organizationId, blueprintId, printProviderId, currentUser).map {
            it.toResponse()
        }
    ...
    fun create(
        ...
        val product =
            productService.create(
                ...
                request.printifyBlueprintId,
                request.printifyPrintPosition,
                currentUser,
            )
    ...
    fun updateManualProduct(
        ...
        val product =
            productService.updateManualProduct(
                organizationId,
                productId,
                request.name,
                request.description,
    ...
    fun createVariant(
        ...
        val variant =
            productService.createVariant(
                organizationId,
                productId,
                request.printifyPrintProviderId,
                request.printifyVariantId,
                request.label,
                request.priceMinor,
                currentUser,
            )
    ...
    fun createManualVariant(
        ...
        val variant =
            productService.createManualVariant(
                organizationId,
                productId,
                request.label,
                request.sku,
