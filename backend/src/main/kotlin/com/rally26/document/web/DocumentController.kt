package com.rally26.document.web
...
class DocumentController(
    ...
    fun listAcknowledgments(
        ...
        DocumentAcknowledgmentListResponse(
            documentService.listAcknowledgments(organizationId, assignmentId, currentUser).map { it.toResponse() },
        )
    ...
    fun acknowledgeDocument(
        ...
        @PathVariable assignmentId: UUID,
        @AuthenticationPrincipal currentUser: CurrentUser,
    ): DocumentAcknowledgmentResponse = documentService.acknowledge(organizationId, householdId, assignmentId, currentUser).toResponse()
}
