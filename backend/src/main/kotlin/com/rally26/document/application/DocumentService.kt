...
class DocumentService(
    ...
    fun listOrganizationDocuments(
        organizationId: UUID,
        currentUser: CurrentUser,
    ): List<MediaAssignment> {
        membershipService.requireActiveMembership(organizationId, currentUser)
        return mediaAssignmentRepository
            .listActive(MediaEntityType.ORGANIZATION, organizationId)
    ...
    fun acknowledge(
        ...
        val relationship =
            guardianRelationshipRepository.findActiveForHousehold(currentUser.userId, householdId)
        ...
        val acknowledgment =
            documentAcknowledgmentRepository.insert(
                organizationId = organizationId,
    ...
    fun listAcknowledgments(
        ...
        val assignment = requireDocumentAssignment(organizationId, assignmentId)
        val authorized =
            if (assignment.entityType == MediaEntityType.HOUSEHOLD) {
