...
class CoachDashboardService(
     ...
     */
    private fun resolveSelectedOrDefaultTeam(
        organizationId: UUID,
        currentUser: CurrentUser,
        teamId: UUID?,
    ) = run {
    ...
    private fun requireAnyTeamAccess(
        organizationId: UUID,
        currentUser: CurrentUser,
    ): Set<UUID> {
