...
class OwnerDashboardService(
    ...
    fun getFinancialOverview(
        ...
        return FinancialOverviewResponse(
            ...
            apparelSalesMinor =
                ledgerEntryRepository.sumByOrganizationTypeAndDirection(
                    organizationId,
    ...
    fun getTeamPerformance(
        ...
        return teamRepository
            .findAll(organizationId, offset = 0, limit = TEAM_PERFORMANCE_LIMIT)
            .map { team ->
    ...
    fun getRecentActivity(
        ...
        return auditEventRepository
            .listRecentForOrganization(organizationId, RECENT_ACTIVITY_LIMIT)
            .map { ActivityItem(it.id, it.action, it.entityType, it.entityId, it.createdAt) }
    }

    fun getOnboardingProgress(
        organizationId: UUID,
        currentUser: CurrentUser,
