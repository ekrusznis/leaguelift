...
data class ParsedIcsEvent(
    ...
    val startAt: Instant?,
    val endAt: Instant?,
    /** Raw RFC 5545 value (CONFIRMED/TENTATIVE/CANCELLED) — the caller maps this to [com.rally26.event.domain.EventStatus], not this parser. */
    val status: String?,
)
