package com.rally26.integration.eventsource.web

import com.rally26.integration.eventsource.application.CsvImportResult
...
data class CsvImportRowErrorResponse(
    val rowNumber: Int,
    val message: String,
)
