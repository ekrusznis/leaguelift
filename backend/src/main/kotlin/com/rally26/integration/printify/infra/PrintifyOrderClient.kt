...
private data class SubmitOrderRequestDto(
    val external_id: String,
    val line_items: List<SubmitOrderLineItemDto>,
    val send_shipping_notification: Boolean = false,
)

private data class SubmitOrderResponseDto(
    val id: String,
)
