package com.rally26.integration.googlecalendar.persistence
...
import com.rally26.integration.googlecalendar.domain.GoogleCalendarMappingStatus
            ...
            .sql(
                ...
                values
                    (:connectionId, :calendarId, :calendarName, :timezone,
                     'RALLY26_TO_GOOGLE', false, now(), now(), now())
    ...
    fun markCalendarsListed(connectionId: UUID) {
        jdbcClient
            .sql(
                ...
                values (:connectionId, 'RALLY26_TO_GOOGLE', false, now(), now(), now())
                on conflict (connection_id) do update
