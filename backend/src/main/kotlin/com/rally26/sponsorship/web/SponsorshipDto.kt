...
import com.rally26.sponsorship.application.SponsorDirectoryEntry
import com.rally26.sponsorship.application.SponsorshipCheckout
import com.rally26.sponsorship.application.SponsorshipInvoice
...
data class UpdateSponsorshipPackageStatusRequest(
    @field:NotNull val status: SponsorshipPackageStatus,
)

data class AssignSponsorLogoRequest(
...
fun SponsorshipPackage.toResponse(confirmedCount: Long) =
...
fun SponsorshipPackage.toPublicResponse(confirmedCount: Long) =
    PublicSponsorshipPackageResponse(
        id,
        organizationId,
        name,
        description,
...
data class SponsorshipCheckoutResponse(
...
fun SponsorshipWithSponsor.toResponse() =
    SponsorshipResponse(
        sponsorship.id,
        sponsorship.status.name,
        sponsorship.paymentSource.name,
        sponsorship.amountMinor,
        sponsorship.currency,
        sponsor.id,
        sponsor.name,
        sponsor.contactEmail,
        sponsorship.confirmedAt,
        sponsorship.refundedAt,
...
fun SponsorshipInvoice.toResponse() =
    SponsorshipInvoiceResponse(
