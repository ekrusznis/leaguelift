...
import com.rally26.media.application.RequestUploadResult
...
fun parseUsageSlot(value: String): MediaUsageSlot =
    try {
...
fun parseEntityType(value: String): MediaEntityType =
    try {
...
fun RequestUploadResult.toResponse() =
...
fun MediaAsset.toConfirmResponse() =
...
fun MediaDescriptor.toResponse() =
...
data class MediaAssignmentListResponse(
    val items: List<MediaAssignmentResponse>,
)
