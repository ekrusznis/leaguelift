package com.rally26.media.persistence
...
class MediaAssignmentRepository(
    ...
    fun findById(
        ...
        jdbcClient
            .sql("select $MEDIA_ASSIGNMENT_COLUMNS from media_assignment where id = :id and organization_id = :organizationId")
            .param("id", id)
